...
const PostJob = () => {
  ...
  // Handle standard text/number input changes
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      // Example: const res = await axios.post(`${JOB_API_END_POINT}/post`, input, { withCredentials: true });
    } catch (error) {
      console.error(error);
    } finally {
      setLoading(false);
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {companies.length > 0 && (
              <div className="col-span-2">
                ...
                <select
                  className="w-full border border-gray-300 rounded-md p-2 my-1"
